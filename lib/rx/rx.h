...
#define RECEIVER_MAX_LENGTH_QUEUES          12
#define RECEIVER_NUM_CHANNEL                3

#define ERROR_RATE_CHANNEL_1                0       // Channel 2 MC6C
#define ERROR_RATE_CHANNEL_2                30      // Channel 4 MC6C
#define ERROR_RATE_CHANNEL_3                0      // Channel 6 MC6C
...
public:
    ...
    void begin(bool hasErrorRateReceiver);
...
private:
    ...
    int* valErrorRateSpecificReceiver;
